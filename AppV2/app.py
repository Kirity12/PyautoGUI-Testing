...
class App(tk.Tk):
    def __init__(self):
        ...
        set_up_button = tk.Button(self.page3, height=1, width=10, text="Set",
                    command=set_text_by_button)
        set_up_button.pack(padx=70)
        sample_text.config(state=tk.DISABLED)

        button2 = ttk.Button(self.page3, text="Go to Page Adobe Illustrator", command=self.show_page3)
        ...
        check_var1.set(0)
        checkbox1 = ttk.Checkbutton(self.page2, text="Rotate thumbnail anti-clockwise", variable=check_var1)  # Added a checkbox
        ...
        rotate_image(0)
        w2 = tk.Scale(self.page2, from_=0, to=360, tickinterval= 30, orient=tk.VERTICAL, length=300, command = rotate_image)
